# ATTEMPT 2 at building the sp3 protocol step by step it will begin as an improved copy of katarinas sp3_v3 but not be hard-coded
# but instead utilize the parameter functionality to make it more flexible
from opentrons import protocol_api
from opentrons.types import Point

metadata = {
    'protocolName': 'SP3 Sample Preparation v2.0',
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    #! changed bottom from 70 tp 60, to ensure etoh pickup for all samples
    ...
    for i in range(3):  # Repeat wash 3 times
        ...
        p300.transfer(protocol.params.etoh80_vol, etoh80.bottom(40), [well.bottom().move(Point(1,0,1)) for well in magwells]
                    , mix_after = (10, protocol.params.etoh80_vol if mix_vol_wash < 300 else 300, [well.bottom().move(Point(1,0,1)) for well in magwells])
                    , new_tip = 'always',
