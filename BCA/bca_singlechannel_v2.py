...
#! changes from v1:
# split WR transfer into two pipetting steps to get nice pipetting height throughout 
...
def add_parameters(parameters: protocol_api.ParameterContext):
    ...
    well_plate = [{'display_name': 'A1', 'value': '0'}, {'display_name': 'B1', 'value': '1'}, {'display_name': 'C1', 'value': '2'}, {'display_name': 'D1', 'value': '3'},
                    ...
                    {'display_name': 'A7', 'value': '48'}, {'display_name': 'B7', 'value': '49'}, {'display_name': 'C7', 'value': '50'}, {'display_name': 'D7', 'value': '51'},
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    #! adjustment - splitting WR addition in two to pipette at a nice height
    ...
    for j in range(replicates//2, replicates):
        p300.transfer(200, reservoir['A1'].bottom(20), plate.rows()[j][0:9], new_tip='always', mix_after=(3,150))
